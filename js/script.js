...
const skillsData = [
  ...
  { name: 'Adobe Photoshop', level: 68, desc: 'Edição e tratamento de imagens para design gráfico.' },
  { name: 'Adobe illustrator', level: 68, desc: 'Criação e edição de gráficos vetoriais para design gráfico.' },
  { name: 'Adobe After Effects', level: 68, desc: 'Criação e edição de efeitos visuais para design gráfico.' },
  { name: 'Edição de vídeos em geral', level: 68, desc: 'Edição e tratamento de vídeos para redes ou mídias sociais.' },
  { name: 'Edição de imagens em geral', level: 68, desc: 'Edição e tratamento de imagens para fins diversos.' }
